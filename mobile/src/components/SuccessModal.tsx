      ...
      <View className="flex-1 bg-black/50 justify-center items-center p-5">
        <View className="bg-white rounded-2xl p-6 w-full max-w-sm shadow-lg">
          <View className="items-center mb-5">
            <Text className="text-xl font-bold text-green-600 text-center">Contratação Realizada</Text>
          </View>
          ...
          <View className="mb-5">
            ...
            <View className="flex-row justify-between items-start mb-3 pb-2 border-b border-gray-200">
              ...
              <Text className="text-sm text-blue-600 font-bold flex-2 text-right">{data.price}</Text>
            </View>
          ...
          <View className="items-center">
            ...
            <TouchableOpacity className="bg-green-600 rounded-lg py-3 px-8 min-w-30 items-center" onPress={onClose}>
